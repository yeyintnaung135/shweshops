...
@section('title', 'MOE Admin Team | Directory Edit')
                        ...
                        <form method="POST" enctype="multipart/form-data"
                            ...
                            <div class="se form-group row">
                                <div class="col-12 col-md-6">
                                    <label for="exampleInputEmail1">ဆိုင် အမည် <span style="color: red;">*</span></label>
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="shop_name" type="text"
                                            ...
                                            value="{{ old('shop_name', $ttdata->shop_name) }}" placeholder="ဆိုင် အမည်"
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="shop_name_myan" type="text"
                                            ...
                                            name="shop_name_myan"
                                            value="{{ old('shop_name_myan', $ttdata->shop_name_myan) }}"
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="main_phone" value="{{ old('main_phone', $ttdata->main_phone) }}"
                                            ...
                                            class="form-control @error('main_phone') is-invalid @enderror" name="main_phone"
                                            placeholder="Main Phone" autocomplete="new-password">
                                    </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class=" form-control-tags js-tagify" id="additional_phones"
                                            ...
                                            value="{{ old('additional_phones', $ttdata->additional_phones) }}">
                                    </div>
                                </div>
                            ...
                            <div class="se form-group row">
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="hidden" id="state" name="state"
                                        value="{{ old('state') ? old('state') : $ttdata->state }}">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="hidden" id="township" name="township"
                                        value="{{ old('township') ? old('township') : $ttdata->township }}">

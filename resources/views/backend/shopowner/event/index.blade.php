                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-end align-items-center">
                                <h3 class="card-title">
                                    <a href="{{ route('backside.shop_owner.events.create') }}" class="btn btn-primary">
                                        <span class="fa fa-plus-circle"></span>&nbsp;&nbsp;Create New Event
                                    </a>
                                </h3>
                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            const eventTable = $('#eventTable').DataTable({
                ...
                "serverSide": true,
                "ajax": {
                    "url": "{{ route('backside.shop_owner.events.getEvents') }}",
                    "data": function(d) {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, full, meta) {
                            const image = `<img src= "{{ filedopath('/news_&_events/event/thumbs/' . '${data}') }}"/>`;
                            return image;
                        }
                    },
                    {

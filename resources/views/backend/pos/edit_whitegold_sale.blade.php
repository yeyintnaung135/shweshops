                ...
                <div class="card">
                    <div class="card-body">
                        {{-- <span class="offset-5  mt-2 font-weight-bold" style="font-size:19px;">Create Purchase Form (ရွှေ)</span> --}}
                         <form action="{{route('backside.shop_owner.pos.update_sale_whitegold',$sale->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-7">
                                    <h4 class="text-color mt-2">​<i class="fa fa-chevron-left" aria-hidden="true" onclick="back()"></i> &nbsp;&nbsp;ရွှေဖြူအ​ရောင်းစာရင်းပြင်ဆင်ခြင်း</h4>
                         ...
                         <div class="row mt-5">
                            <div class="col-5">
                                <div class="row">
                                    ...
                                    <div class="col-6 form-group">
                                        ...
                                        <input type="text" name="whitegold_type" class="form-control" id="whitegold_type" value="{{$sale->purchase->whitegold_type}}" required>
                                    </div>
                                    <div class="col-6 form-group">
                            ...
                            <div class="offset-1 col-5">
                                <div class="row">
                                    ...
                                    <div class="col-6 form-group" style="margin-top:34px;">
                                        <label for="total_price">စုစု​ပေါင်းကျ​ငွေ</label>

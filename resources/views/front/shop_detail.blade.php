                        ...
                        <div class="pt-2 ps-4 col-lg-8">
                            ...
                            <div class="d-flex pt-1 py-lg-1">
                                ...
                                <div>
                                    ...
                                    <a href="#phoneModal" data-toggle="modal" data-target="#phoneModal" class="sop-social" id="phone-button">
                                        <i class="sop-social-i fa-solid fa-phone pe-1 pe-md-2 sn-phone"></i>
                                        <div class="d-none d-sm-block">Phone</div>
                                    </a>
                                    <!-- Modal -->
                                    <div class="modal fade contact-modal-backside" id="phoneModal" tabindex="-1" aria-labelledby="phoneModal" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content contact-modal">
                                            ...
                                            <a class="w-100" data-toggle="collapse" href="#collapseMoreAddr" role="button" aria-expanded="false" aria-controls="collapseExample">
                                                <div class="d-flex justify-content-between mx-4 px-2 py-0" id="address-class">
                                                    <p class="text-break" style="text-align: left; font-size: 20px; height: auto; ; line-height: 32px;color:black;font-weight:700">
                                                        Other Addresses
                                                    </p>
                                            ...
                                            <div class="collapse" id="collapseMoreAddr">
                                                <div class="modal-body pt-3 mx-3 mt-2" id="other_address_modal">
                                                </div>
                                            </div>
                                            @endif
                                            {{-- more address --}}
                                            ...
                                            <a class="w-100 mt-2" data-toggle="collapse" href="#collapseMap" role="button" aria-expanded="false" aria-controls="collapseExample">
                                                <div  class="d-flex justify-content-between modal-body mx-3 py-0 sop-chevron " id="map-class">
                                                    <p class="font-weight-bold text-break" style="text-align: left; font-size: 20px;height: auto; ; line-height: 32px; color:black;font-weight:700" >
                                                        Google Map
                                                    </p>

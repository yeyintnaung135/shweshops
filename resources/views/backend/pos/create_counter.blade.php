    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                         <form action="{{route('backside.shop_owner.pos.store_counter')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                           <h4 class="text-color mt-2">​<i class="fa fa-chevron-left" aria-hidden="true" onclick="back()"></i> &nbsp;&nbsp;ဆိုင်ခွဲစာရင်းသွင်းခြင်း</h4>
                           <div class="col-5">
                                    ...
                                    <div class="col-6">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <input type="number" class="form-control" name="staff_no">
                                            </div>
                                            <div class="form-group col-6">
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <input type="number" class="form-control" name="otherno">
                                            </div>
                                            ...
                                            <div class="form-group col-12">
                                                ...
                                                <textarea class="form-control" name="offdays"></textarea>
                                            </div>
                                            <div class="form-group col-12">

<?php $__env->startSection('title', 'MOE Admin Team | Shops List'); ?>

<?php $__env->startSection('content'); ?>
    <div class="wrapper">
        <?php echo $__env->make('backend.super_admin.loading', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            ...
                            <div class="sn-table-list-wrapper">
                                <div class="card shadow-none border-0 rounded-5 pb-2 mt-5">
                                    <div class="card-header">
                                        ...
                                        <a href=" <?php echo e(route('backside.super_admin.shops.create')); ?> " class="btn btn-primary">Add Shop</a>
                                    </div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        var shopsTable = $('#superAdminTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "<?php echo e(route('backside.super_admin.shops.getAllShops')); ?>",
                'data': function(data) {
                    // Read values
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type) {
                        var image = `<img src="<?php echo e(filedopath('/shop_owner/logo/' . ':img')); ?>"
                ...
                },
                {
                    data: 'shop_banner',
                    render: function(data, type) {
                        var image = `<img src="<?php echo e(filedopath('/shop_owner/banner/' . ':img')); ?>"
                ...
                },
                {
                    data: 'action',
                    render: function(data, type) {
                        var edit = `<a href="<?php echo e(url('backside/super_admin/shops/edit/:id')); ?>" role="button" class="btn btn-sm btn-info" data-toggle="tooltip" data-placement="top" title="Shop Edit">
                        <i class="fa fa-edit"></i>
                      </a>`;
                        edit = edit.replace(':id', data);
                        var detail = `
                      <a href="<?php echo e(route('backside.super_admin.shops.detail', ':id')); ?>" role="button" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="Shop Detail">
                        <i class="fa fa-eye"></i>
                      </a>
          `;
                        var detail = detail.replace(':id', data);
                        var del = `<form action="<?php echo e(route('backside.super_admin.shops.trash', ':id')); ?>" method="post">
                      <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.backend.super_admin.datatable', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH P:\xampp\htdocs\shweshops\resources\views/backend/super_admin/shops/all.blade.php ENDPATH**/ ?>
...
<div class="sn-marquee">
  <div class="sn-marquee-item-container">
    <span class="sn-marquee-item">
      <span class="sell-price"><img src="{{asset('images/icons/Gold-Price.png')}}" />ရောင်းစျေး({{ isset($gold_price->sell_price) ? $gold_price->sell_price : '' }})</span>
      <span class="buy-price"><img src="{{asset('images/icons/Gold-Price.png')}}" />ဝယ်စျေး({{ isset($gold_price->buy_price) ? $gold_price->buy_price : '' }})</span>
    </span>
  </div>
</div>

                ...
                <div class="row">
                    ...
                    <div id="" class="col-12">
                        ...
                        <form method="POST" enctype="multipart/form-data"
                            ...
                            <div class="se form-group row">
                                <div class="col-md-12 col-12">
                                    <label for="valuable_product">တန်ဖိုးမြင့်အထည် နှင့်
                                        အထည်မပျက်ပြန်လဲ</label>
                                    <div class="input-group mb-3">

                                        <input value="{{ old('valuable_product') }}" min="0"
                                            id="valuable_product"
                            ...
                            <div class="se form-group row">
                                ...
                                <div class="col-md-12 col-12">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="damaged_product" value="{{ old('damaged_product') }}"
                                            min="0" type="text"
                                            class="form-control @error('damaged_product') is-invalid @enderror"
                                            name="damaged_product" placeholder="10 % or 10000ကျပ် "
                                            autocomplete="new-password">
                                    </div>

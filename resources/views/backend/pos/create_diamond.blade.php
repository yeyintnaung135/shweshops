    ...
    <!-- Content Wrapper. Contains page content -->
        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                         <form action="{{route('backside.shop_owner.pos.store_diamond')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                           <h4 class="text-color mt-2">​<i class="fa fa-chevron-left" aria-hidden="true" onclick="back()"></i> &nbsp;&nbsp;စိန်​ကျောက်ထည်အမည်စာရင်းသွင်းခြင်း</h4>
                           <div class="col-5">
                                    ...
                                    <div class="col-6">
                                        <div class="row">
                                            <div class="form-group col-6">
                                                ...
                                                <input type="text" class="form-control" name="diamond_name">
                                            </div>
                                            ...
                                            <div class="form-group col-6">
                                                ...
                                                <input type="text" class="form-control" name="carrat">
                                            </div>

                                            <div class="form-group col-6">
                                                <label for="yati" class="col-form-label">ရတီဈေးနှုန်း</label>
                                                <input type="text" class="form-control" name="yati">
                                            </div>

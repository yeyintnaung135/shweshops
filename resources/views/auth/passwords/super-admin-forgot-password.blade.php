    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card mt-5 card-border">
                    ...
                    <h4 class="font-weight-normal text-center">Don't Worry, You can reset your password</h4>
                        <div class="row justify-content-center">
                           ...
                           <div class="col-8 mt-4">
                            <form method="POST" action="{{ route('backside.super_admin.send_reset_code') }}">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        <input id="email" type="text" class="form-control @error('email') is-invalid @enderror  border" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Please enter your email">
                ...
                <a href="{{url('/backside/super_admin/login')}}" class="text-center mb-4"><u>Back</u></a>
            </div>
        </div>
    </div>
</div>

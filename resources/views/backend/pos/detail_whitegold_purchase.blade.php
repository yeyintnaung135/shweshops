            ...
            <div class="container-fluid">
                ...
                <div class="row mt-3">
                    <div class="col-11">
                        <div class="card">
                            <div class="card-body">
                                <h6 class="text-color">ရွှေဖြူအထည်အ​ကြောင်းများ</h6>
                                <div class="row mt-3">
                                    <div class="col-7">
                                        <div class="row">
                                            <div class="col-4">
                                             <h6 class="mt-4">ရောင်းဈေး</h6>
                                              ...
                                              <h6 class="mt-4">ရွှေဖြူအရည်အသွေး</h6>
                                              <h6 class="mt-4">ရွှေဖြူအမျိုးအစား</h6>
                                            ...
                                            <h6 class="text-color mt-4">{{$purchase->product_gram}} gram</h6>
                                              ...
                                              <h6 class="text-color mt-4">{{$purchase->whitegold_name}}</h6>
                                              <h6 class="text-color mt-4">{{$purchase->quality}}</h6>
                                              <h6 class="text-color mt-4">{{$purchase->whitegold_type}}</h6>
                                    ...
                                    <div class="col-5">
                                    @if(dofile_exists('main/images/pos/whitegoldpurchase_photo/'.$purchase->photo))
                                    <img src="{{url('/pos/whitegoldpurchase_photo/'.$purchase->photo)}}"/>
                                    @else
                                    <img src="{{filedopath('/pos/whitegoldpurchase_photo/'.$purchase->photo)}}"/>
                                    @endif
                                        <!-- <img src="{{filedopath('pos/whitegoldpurchase_photo/'.$purchase->photo)}}" alt=""> -->
                                        <div class="mt-5">
                                            <input type="hidden" id="text" value="{{$purchase->barcode}}"/>
                                            <input type="hidden" id="scan_text" value="{{$purchase->barcode_text}}"/>
                                            <div>
                                                <div id="showVal"></div>
                                                <div id="bcTarget"></div>
                                            </div>
                                    ...
                                    <div class="col-7">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-7">
                                              <h6 class="text-color mt-4">{{$purchase->product_gram}} gram</h6>
                                              <h6 class="text-color mt-4">{{$profit[0]}} {{$profit[1]}}</h6>
                                              <h6 class="text-color mt-4">{{$purchase->capital}} mmk</h6>
                                              <h6 class="text-color mt-4">{{$purchase->selling_price}} mmk</h6>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-1">
                        <a href="{{route('backside.shop_owner.pos.edit_wg_purchase',$purchase->id)}}" class="ml-2 mt-4 btn btn-sm btn-warning text-white"><i class="fa fa-pencil" ></i></a><br>
            ...
            // alert(id);
                $.ajax({
                    ...
                    success:function(data){
                        // window.open('https://test.shweshops.com/backside/shop_owner/wgpurchase_list');
                       window.location.href = "{{ route('backside.shop_owner.pos.wg_purchase_list')}}";
                    }
                })

          ...
          <div class="ftc-product product mb-2" style="box-shadow: none !important">
            <div class="post-img sop-img">
              ...
              >
                ...
                >
                  <img
                    v-lazy="host + '/images/logo/thumbs/' + item.ShopName.shop_logo"
                    class="yk-hover-logo float-left"
                  />
                  <span> {{ item.ShopName.shop_name | strlimit(15, "..") }}</span>
                </div>
              </a>
              ...
              <a
                ...
                "
              >
                <img :src="imgurl + item.CheckPhoto" class="sop-image-w-h" />
              </a>
            </div>
...
export default {
  ...
  methods: {
    loadPopularItemsMore() {
      ...
      axios
        .get(
          this.host + "/get_popitems_ajax/" + this.popularlatest + "/" + this.popularlimit
        )
        .then((response) => {

                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="row d-flex">
                                <h4 class="text-color">ရွှေဖြူ အ​ရောင်းစာရင်းများ</h4>
                                <a class="btn btn-m btn-color ml-3"
                                    href="{{ route('backside.shop_owner.pos.sale_wg_purchase') }}">
                    ...
                    <div class="card mt-2">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-3 card" style="max-height: 70px;">
                                    <h6 class="text-color mt-2">ရောင်းရ​ငွေစုစု​ပေါင်း &nbsp;&nbsp;&nbsp;<span id="tot_sale">0</span> ကျပ်</h6>
                                </div>
                            </div>

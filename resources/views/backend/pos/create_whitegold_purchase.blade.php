                ...
                <div class="card">
                    <div class="card-body">
                        {{-- <span class="offset-5  mt-2 font-weight-bold" style="font-size:19px;">Create Purchase Form (ရွှေ)</span> --}}
                         <form action="{{route('backside.shop_owner.pos.store_wg_purchase')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-7">
                                    <h4 class="text-color mt-2">​<i class="fa fa-chevron-left" aria-hidden="true" onclick="back()"></i> &nbsp;&nbsp;​ရွှေဖြူစာရင်းသွင်းခြင်း</h4>
                         ...
                         <div class="row mt-5">
                            <div class="col-3 form-group">
                                ...
                                <input type="text" name="wg_name" class="form-control" required>
                            </div>
                            <div class="col-3 form-group">
                            ...
                            <div class="col-3 form-group">
                                ...
                                <input type="text" name="wg_type" class="form-control">
                            </div>
                            <div class="col-3 form-group">
                            ...
                            <div class="col-3" hidden>
                                <input type="text" name='wg_price' id='wg_price' value="{{$gradeA}}">
                            </div>

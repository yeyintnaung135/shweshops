                        ...
                        <div class="text-center">
                            <div class="d-flex justify-content-center">
                                <div class="profile mb-2 rounded-circle">
                                    @if ($user->photo === null)
                                        <img src="{{ asset('images/user-profile/default-profile.png') }}" alt=""
                                            class="w-100">
                                    @else
                            ...
                            <div class="mt-3 d-flex justify-content-center w-100">
                                <a href="{{ route('backside.user.edit', $user->id) }}" role="button"
                                    class="btn shwe-shop-secondary-bg-color btn-sm">
            ...
            <div class="row justify-content-center align-items-center mb-3">
                <div class="col-6 col-md-5 col-lg-2 d-flex justify-content-center align-items-center p-0">
                    <div class="shweshops-points-icon my-2 rounded-circle">
                        <img src="{{ asset('images/user-profile/Shwe-shops-logo.jpg') }}" alt=""
                ...
                <div class="col-6 order-12 order-md-12 order-lg-0  col-lg-2 p-0  my-height-25 mobile-display-none">
                    <div class="d-flex align-items-center justify-content-center">
                        <div class="row align-items-center justify-content-center w-100 mt-1">
                            ...
                            <div class="col-4 d-block text-center p-0">
                                <span
                                    class="shweshops-secondary-text-color font-weight-bolder">{{ $sum }}</span><br>
                                <p class="text-black-50 sm-count-text sm-line-height">Total Points</p>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="px-1 px-lg-5 card-container  d-flex justify-content-center">
                                    <div class="my-card">
                                        <div class="my-card-header card-header-font-size py-lg-4 p-4 mt-lg-3 ">
                                            <div class="icons">
                                                <img src="{{ asset('images/user-profile/account.png') }}" class="w-50"
                                                    alt="account">
                                            </div>
                                        ...
                                        <div class="my-card-body p-4">
                                            <div class="d-flex justify-content-between pointer mb-4">
                                                <a href="{{ route('backside.user.user_profile') }}"
                                                    class="text-black-50 card-header-inner-font-size ml-1 ml-lg-0">My
                                                    Information</a>
                                                <i class="fas fa-angle-right text-black-50"></i>
                                            </div>
                                            <div class="d-flex justify-content-between pointer">
                                                <span class="text-black-50 card-header-inner-font-size ml-1 ml-lg-0">Change
                                                    Password</span>
                                                <i class="fas fa-angle-right text-black-50"></i>
                                            </div>
                                        </div>
                                        <div class="my-card-header card-header-font-size py-lg-4 p-4 mt-lg-3">
                                            <div class="icons">
                                                <img src="{{ asset('images/user-profile/noti.png') }}" class="w-50"
                                                    alt="account">
                                            </div>
                                        ...
                                        <div class="my-card-body p-4">
                                            <div class="d-flex justify-content-between pointer">
                                                <span
                                                    class="text-black-50 card-header-inner-font-size ml-1 ml-lg-0">Promotion</span>
                                                <i class="fas fa-angle-right text-black-50"></i>
                                            </div>
                                        </div>
                                        <div class="my-card-header card-header-font-size py-lg-4 p-4 mt-lg-3">
                                            <div class="icons">
                                                <img src="{{ asset('images/user-profile/other.png') }}" class="w-50"
                                                    alt="account">
                                            </div>
                                        ...
                                        <div class="my-card-body p-4">
                                            <div class="d-flex justify-content-between mb-lg-4 mb-5 pointer">
                                                <span
                                                    class="text-black-50 card-header-inner-font-size ml-1 ml-lg-0">FAQ</span>
                                                <i class="fas fa-angle-right text-black-50"></i>
                                            </div>
                                            <div class="d-flex justify-content-center">
                                                <form method="POST" action="{{ route('backside.user.logout') }}"
                                                    id="logout">
                                                    @csrf

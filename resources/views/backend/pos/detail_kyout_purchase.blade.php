        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mt-3">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row mt-3">
                                        ...
                                        <div class="row">
                                           ...
                                           ?>
                                            <div class="col-6">
                                              ...
                                              <h6 class="text-color mt-4">{{$purchase->diamond_selling_price}} ကျပ်</h6>
                                            ...
                                            <h6 class="text-color mt-4">{{$diamond[1] ? $diamond[1].'ကျပ်' : ''}} {{$diamond[2] ? $diamond[2].'ပဲ' : ''}} {{$diamond[3] ? $diamond[3].'ရွေး' : ''}}</h6>
                                    ...
                                    @else
                                    <img src="{{filedopath('/pos/kyoutpurchase_photo/'.$purchase->photo)}}"/>
                                    @endif
                    ...
                    <div class="col-1">
                        <a href="{{route('backside.shop_owner.pos.edit_kyout_purchase',$purchase->id)}}" class="ml-2 mt-4 btn btn-sm btn-warning text-white"><i class="fa fa-pencil" ></i></a><br>
            ...
            // alert(id);
                $.ajax({
                    ...
                    success:function(data){
                       window.location.href = "{{ route('backside.shop_owner.pos.kyout_purchase_list')}}";
                        // window.open('https://test.shweshops.com/backside/shop_owner/kpurchase_list');
                    }
                })

...
//Staff
    ...
    public function staffTypeFilter(Request $request){
    ...
    public function returnTypeFilter(Request $request){
    ...
    public function addPurchaseReturn(Request $request){
     ...
     //Filter
     public function filterSellFlag(Request $request){
        if($request->val == 1){
    ...
    public function getPurchaseLists(){
       ...
       public function getSaleLists(){
        ...
        public function tabIncomeLists(Request $request){
            $subtotal = 0;$qty=0;$purchase = [];
    ...
    public function tabStockLists(Request $request){
        $qty = 0;$purchase = [];
        if($request->type == 2 || $request->type == 1){
            if ($request->start && $request->end){

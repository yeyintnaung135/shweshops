            ...
            <section class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="row mt-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mt-3">
                                                ...
                                                <div class="col-12">
                                                    <table cellspacing="0" cellpadding="0" style="border: none;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>-</td>
                                                            <td><span class="text-color ">{{ $purchase->price }}
                                                                    ကျပ်</span>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>-</td>
                                                            <td><span class="text-color ">{{ $purchase->amount }}
                                                                    ကျပ်</span>
                                                            </td>
                                                        ...
                                                        @if ($purchase->return_price)
                                                            <tr>
                                                                ...
                                                                <td>-</td>
                                                                <td><span class="text-color ">{{ $purchase->return_price }}
                                                                        ကျပ်</span>
                                                                </td>
                                                        ...
                                                        @if ($purchase->return_price)
                                                            <tr>
                                                                ...
                                                                <td>-</td>
                                                                <td><span class="text-color ">{{ $purchase->left_price }}
                                                                        ကျပ်</span>
                                                                </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>-</td>
                                                            <td><span class="text-color ">
                                                                    {{ $purchase->purchase->name }}</span> </span>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>-</td>
                                                            <td><span class="text-color ">
                                                                    {{ $purchase->purchase->quality->name }}</span> </span>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>-</td>
                                                            <td><span class="text-color ">
                                                                    {{ $purchase->purchase->gold_type }}</span> </span>
                                                            </td>
                                        ...
                                        <div class="col-5 ">
                                            <img src="{{ asset('main/images/pos/goldpurchase_photo/' . $purchase->purchase->photo) }}"
                                                alt="">
                                            <div class="mt-5">
                        ...
                        <div class="col-1">
                            <a href="{{ route('backside.shop_owner.pos.edit_goldsale', $purchase->id) }}"
                            ...
                            <form id="delete_form_{{ $purchase->id }}"
                                action="{{ route('backside.shop_owner.pos.delete_goldsale', $purchase->id) }}"

    ...
    <div class="sn-marquee-item-container">
        <span class="sn-marquee-item">
            <span class="sell-price"><img
                    src="<?php echo e(asset('images/icons/Gold-Price.png')); ?>" />ရောင်းစျေး(<?php echo e(isset($gold_price->sell_price) ? $gold_price->sell_price : ''); ?>)</span>
            <span class="buy-price"><img
                    src="<?php echo e(asset('images/icons/Gold-Price.png')); ?>" />ဝယ်စျေး(<?php echo e(isset($gold_price->buy_price) ? $gold_price->buy_price : ''); ?>)</span>
        </span>
    </div>
</div>
    ...
    <div class="h-100 d-flex justify-content-between align-items-center">
        ...
        <div class="shoplogo-w col-4 d-flex flex-row justify-content-center align-items-center ">
            <a href="/" class="d-flex flex-row justify-content-center align-items-end">
                <img src="<?php echo e(url('test/img/logo-m.png')); ?>" class="" alt="">
        ...
        <div class="d-flex justify-content-end align-items-center col-4">
            ...
            <?php if(isset(Auth::guard('web')->user()->id)): ?>
                ...
                <div class="dropdown">
                    <div class="dropbtn menu-profile rounded-circle sop-upper-nav-text-l">
                        <?php if(Auth::guard('web')->user()->photo == null): ?>
                            <img src="<?php echo e(asset('images/user-profile/default-profile.png')); ?>" class="w-100">
                        <?php else: ?>
                            <img src="<?php echo e(asset(Auth::guard('web')->user()->photo)); ?>" class="w-100">
                        <?php endif; ?>
                    </div>
                    <div class="dropdown-content rounded">
                        <a class="text-color" href="<?php echo e(route('backside.user.user_profile')); ?>">Profile</a>
                        <form method="POST" action="<?php echo e(route('backside.user.logout')); ?>" id="logout">
                            <?php echo csrf_field(); ?>
            ...
            <?php elseif(isset(Auth::guard('super_admin')->user()->id)): ?>
                <div class="sop-upper-nav-text-l px-3">
                    <a href="" data-toggle="modal" data-target="#notiModal">
                        <i class="far fa-bell  fa-lg" style="color:#F7B538 !important;" id="mobileFootNoti"></i>
                    </a>
...
<?php $__env->stopPush(); ?>
<?php /**PATH P:\xampp\htdocs\shweshops\resources\views/layouts/frontend/allpart/upper_menu.blade.php ENDPATH**/ ?>
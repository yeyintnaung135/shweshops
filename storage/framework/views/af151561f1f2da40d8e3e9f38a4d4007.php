...
<script>
    ...
    //         </div>`);
    //     }
    //     <?php if(isset(Auth::guard('shop_owners_and_staffs')->user()->id) ): ?>
    //         var noti = <?php echo Auth::guard('shop_owners_and_staffs')->user(); ?>.notification
    //     <?php elseif(isset(Auth::guard('web')->user()->id) ): ?>
    //         var noti = <?php echo Auth::guard('web')->user(); ?>.notification
    ...
    //     <?php if(isset(Auth::guard('web')->user()->id) || isset(Auth::guard('shop_owners_and_staffs')->user()->id) || isset(Auth::guard('shop_owners_and_staffs')->user()->id)): ?>
    //     pushDiscount();
...
<?php $__env->stopPush(); ?>
<?php /**PATH P:\xampp\htdocs\shweshops\resources\views/layouts/frontend/allpart/noti.blade.php ENDPATH**/ ?>
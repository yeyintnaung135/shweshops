        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mt-3">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-5">
                                        <img src="{{asset('images/pos/kyoutpurchase_photo/'.$purchase->purchase->photo)}}" alt="">
                                        <div class="mt-5">
                    ...
                    <div class="col-1">
                        <a href="{{route('backside.shop_owner.pos.edit_kyoutsale',$purchase->id)}}" class="ml-2 mt-4 btn btn-sm btn-warning text-white"><i class="fa fa-pencil" ></i></a><br>
                        <a class="ml-2 mt-4 btn btn-sm btn-danger" onclick="Delete({{$purchase->id}})"
                            title="Delete">
                            <span class="fa fa-trash"></span>
                            </a>
                            <form id="delete_form_{{$purchase->id}}" action="{{route('backside.shop_owner.pos.delete_kyoutsale',$purchase->id)}}" method="POST"
                                style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>

...
@section('title', 'MOE Admin Team | Tooltip Edit')
                            ...
                            <div class="sn-table-list-wrapper">
                                ...
                                <div class="card shadow-none card-outline card-primary rounded-5 pb-2 mt-5">
                                    ...
                                    <div class="card-body p-lg-5">
                                        <form method="POST"
                                            action="{{ url('backside/super_admin/tooltips/update/' . $tooltip->id) }}">
                                            @csrf
                                            <div class="form-group">
                                                <label for="exampleInputEmail1">URL</label>
                                                <input type="text" value="{{ old('endpoint', $tooltip->endpoint) }}"
                                                    name="endpoint"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="summernote" name="info">{{ old('info', $tooltip->info) }}</textarea>
                                                @error('info')
                                                    <span class="font-weight-bold text-danger" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                            ...
                                            <a href="{{ url('backside/super_admin/tooltips/list') }}"

         ...
         function goldtypefilter(val){
            ...
            success:function(data){
                ...
                $.each(data.data, function(i, v) {
                    ...
                    var url2 = '{{ route('backside.shop_owner.pos.detail_purchase', ':purchase_id') }}';
                    ...
                    dataTable.row.add([++i,v.gold_name,v.supplier.name,v.code_number,arr[0],html1,v.stock_qty,v.gold_fee,v.date,html2]).draw();
                })
                $('#tot_qty').html(count);
                $('#tot_g').html(tot_g);

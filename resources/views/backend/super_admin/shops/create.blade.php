...
@section('title', 'MOE Admin Team | Shop Create')
                        ...
                        <form method="POST" enctype="multipart/form-data"
                            ...
                            <div class="fs form-group row">
                                ...
                                <div class="col-md-12 col-12">
                                    <label for="exampleInputEmail1">အမည် <span style="color: red;">*</span></label>

                                    <div class="input-group mb-3">

                                        <input id="name" type="text"
                                            class="form-control @error('name') is-invalid @enderror" name="name"
                                            value="{{ old('name') }}" placeholder="အမည်" autocomplete="name" required>
                                    </div>
                            ...
                            <div class="fs form-group row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="password" type="password"
                                            ...
                                            placeholder="စကားဝှက် အသစ်" autocomplete="new-password">
                                    </div>
                                    <h5 id="passwordcheck" style="color: red;">
                                        **Password is missing
                                    </h5>
                                    <small id="passwordvalid"
                                        class="form-text
                                                text-muted">
                                        Your pin must be 6
                                    </small>
                                ...
                                <div class="col-md-12"><button type="button"
                                        class="sn_generate_password btn btn-secondary d-block">Generate Password</button>
                                </div>
                            </div>
                            <div class="fs form-group row">
                            ...
                            <div class="se form-group row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="main_phone" value="{{ old('main_phone') }}" min="0"
                                            type="text" type="text"
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class=" form-control-tags js-tagify" id="sub_phones"
                                            placeholder="Press Enter after each phones" name="additional_phones"
                                            value="{{ old('additional_phones') }}">
                                    </div>
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="hidden" id="hiddentownship" name=""
                                        value="{{ old('township') }}">
                            ...
                            <div class="se form-group row">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <!-- <div class="dropdown-menu"> -->
                                        <input id="fb_link" value="{{ old('page_link') }}" min="0"
                                            type="text"
                                            class="form-control @error('messenger_link') is-invalid @enderror"
                            ...
                            {{-- //page --}}
                            <div class="se form-group row">
                                <div class="col-12 col-md-6" id="premium_template_form">
                                    <label for="premium_template_id">Premium Template<span
                                            style="color: red;">*</span></label>
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label"
                                                for="exampleInputFile">ဆိုင်bannerတင်ရန်</label>
                                        </div>
                            ...
                            <div class="se form-group row">
                                <div class="col-md-12 col-12">
                                    <label for="တန်ဖိုးမြင့်အထည်_နှင့်_အထည်မပျက်ပြန်လဲ">တန်ဖိုးမြင့်အထည် နှင့်
                                        အထည်မပျက်ပြန်လဲ</label>
                                    <div class="input-group mb-3">

                                        <input value="{{ old('တန်ဖိုးမြင့်အထည်_နှင့်_အထည်မပျက်ပြန်လဲ') }}" min="0"
                                            id="တန်ဖိုးမြင့်အထည်_နှင့်_အထည်မပျက်ပြန်လဲ"
                            ...
                            <div class="se form-group row">
                                ...
                                <div class="col-md-12 col-12">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input id="အထည်ပျက်စီးချို့ယွင်း" value="{{ old('အထည်ပျက်စီးချို့ယွင်း') }}"
                                            min="0" type="text"
                                            class="form-control @error('အထည်ပျက်စီးချို့ယွင်း') is-invalid @enderror"
                                            name="အထည်ပျက်စီးချို့ယွင်း" placeholder="10 % or 10000ကျပ် "
                                            autocomplete="new-password">
                                    </div>
                            ...
                            <div class="yk form-group row">
                                ...
                                <div class="col-md-12 col-12">
                                    ...
                                    <textarea id="summernoteDescription" type="description"
                                        class="form-control @error('description') is-invalid @enderror" name="description" placeholder="ဆိုင်အကြောင်း"
                            ...
                            <div class="yk form-group row">
                                <div class="col-12 col-md-6">
                                    <label for="summernoteAddress">Address<span style="color: red;">*</span></label>
                                    <textarea id="summernoteAddress" type="description" class="form-control @error('address') is-invalid @enderror"
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <textarea id="summernoteOtherAddress" type="description"
                                        class="form-control @error('other_address') is-invalid @enderror" name="other_address"
                                        placeholder="More Address" rows="4">{{ old('other_address') }}</textarea>

                                </div>
                                <div class="col-12 col-md-6">
                                    <label for="address">Map</label>
                                    <textarea id="map" type="description" class="form-control" name="map" placeholder="GoogleMap"
                            ...
                            <div class="form-check mb-4 d-flex flex-row no-gutters pl-0">
                                ...
                                <div class="col-12 align-items-end">
                                    ...
                                    <a type="button" name="previous" href="javascript:void(0);"
                                        style="color: #7a7979;font-weight: bolder;" class="previous float-left"><span
                                    ...
                                    <a id="zh_btn_two" type="button" href="javascript:void(0);"
                                        ...
                                        <span class="fa fa-arrow-right"></span> </a>
                                    <a type="button" name="previous" href="javascript:void(0);"
                                        style="color: #7a7979;font-weight: bolder;" class="previous_yk float-left"><span
                                            class="fa fa-arrow-left"></span>
                                        Previous </a>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#premium').on('change', function() {
                $("#premium_template_form").toggle(this.value == "yes");
            ...
            function validateUsername() {
                ...
                if (usernameValue.length == '') {
                    ...
                    $('.yk').hide();
                    $('.next_yk').hide();
                    $('#usercheck').html("**length of username must be between 3 and 500");
                } else {
                    $('#usercheck').hide();
                }

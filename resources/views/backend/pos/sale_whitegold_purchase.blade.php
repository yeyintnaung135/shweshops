                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('backside.shop_owner.pos.store_sale_whitegold') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-7">
                                        <h4 class="text-color mt-2">​<i class="fa fa-chevron-left" aria-hidden="true"
                                                onclick="back()"></i> &nbsp;&nbsp;​​ရွှေဖြူအ​ရောင်းစာရင်းသွင်းခြင်း</h4>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <span class="text-color" style="font-size:19px;">​ရောင်းချမည့် ​ရွှေဖြူ</span>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 form-group">
                                                ...
                                                <input type="text" name="code_number" class="form-control"
                                                    id="code_number" required>
                                            </div>
                                            <div class="col-6 form-group">
                                                <label for="quality">​​ရွှေဖြူအရည်အသွေး</label>
                                                <input type="text" name="quality" id="quality" class="form-control"
                                                    required>
                                            </div>
                                            <div class="col-6 form-group">
                                                <label for="whitegold_type">​ရွှေဖြူအမျိုးအစား</label>
                                                <input type="text" name="whitegold_type" class="form-control"
                                                    id="whitegold_type" required>
                                            </div>
                                            <div class="col-6 form-group">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-3 form-group">
                                                        <input type="number" step="0.01" name="product_weight"
                                                            placeholder="Gram" id="product_weight" class="form-control"
                                                            required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 mt-5">
                                                <span class="text-color"
                                                    style="font-size:19px;">စုစု​ပေါင်းကျမည့်​ငွေ</span>
                                                <input type="hidden" name="" id="wg_price">
                                            </div>
                                            <div class="col-6 form-group" style="margin-top:34px;">
                                                <label for="price">​စျေးနှုန်း</label>
                                                <input type="text" name="price" id="gold_fee" class="form-control"
                                                    required>
                                            </div>
                                            <div class="col-6 form-group" style="margin-top:34px;">
                                            ...
                                            <div class="col-6 form-group">
                                                ...
                                                <input type="text" name="de_price" class="form-control"
                                                    id="de_price" required>
                                            </div> --}}
                                            {{-- <div class="col-6 form-group">
                                ...
                                <div class="row mt-4 offset-8">
                                    ...
                                    {{-- <button class="btn btn-m btn-outline-color text-center"><i class="fa fa-print mr-2"
                                            aria-hidden="true"></i>​ဘောင်ချာထုတ်ရန်</button> --}}
                                </div>
                            </form>
    ...
    if($('#return_sale').is(':checked')){
        ...
        function fillValues(val) {
            $.ajax({
                ...
                url: '{{ route('backside.shop_owner.pos.getSaleWgValues') }}',

...
class PosSaleFilterService
{
    ...
    public function filterKyoutSales($request)
    {
        ...
        $query = PosKyoutSale::join('pos_kyout_purchases', 'pos_kyout_sales.purchase_id', '=', 'pos_kyout_purchases.id')
            ->select('pos_kyout_sales.id', 'pos_kyout_sales.amount', 'pos_kyout_sales.date', 'pos_kyout_purchases.gold_name', 'pos_kyout_purchases.code_number', 'pos_kyout_purchases.gold_gram_kyat_pe_yway');

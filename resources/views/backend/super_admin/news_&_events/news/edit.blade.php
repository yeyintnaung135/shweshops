...
@section('title', 'MOE Admin Team | News Edit')
                        ...
                        <div class="p-1">
                            <div class="card card-outline card-dark">
                                ...
                                <div class="card-body p-4">
                                    <form action="{{ route('backside.super_admin.news.update', $news->id) }}" method="post"
                                ...
                                @enderror"
                                    ...
                                    is-invalid
                                @enderror"
                                                name="description" id="description" rows="7">{{ $news->description }}</textarea>
                                            @error('description')
                                                <small class="text-danger font-weight-bolder">{{ $message }}</small>
                                            @enderror
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="mb-2">
                                                <img src="{{ filedopath('/news_&_events/news/' . $news->image) }}"
                                ...
                                @enderror">
                                        ...
                                        <a href="{{ route('backside.super_admin.news.create') }}"

...
{{--                items--}}
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{route('backside.super_admin.activity.messenger')}}" class="nav-link border-0">
                                {{--                                <i class="far fa-circle nav-icon"></i>--}}
                                <i class="fa fa-circle pl-5"></i>
                ...
                <li class="nav-item py-1 ml-3">
                    <a href="{{ route('backside.super_admin.app-files.index') }}" class="mobile-nav nav-link">
                ...
                <li class="nav-item">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{url('backside/super_admin/showdeletelogs')}}" class="nav-link border-0">

...
@push('scripts')
    <script>
         function ptmtypefilter(val){
            ...
            success:function(data){
                ...
                $.each(data.data, function(i, v) {
                    ...
                    var url2 = '{{ route('backside.shop_owner.pos.detail_ptm_purchase', ':purchase_id') }}';
                    ...
                    dataTable.row.add([++i,v.platinum_name,v.quality,v.platinum_type,v.code_number,v.product_gram,v.stock_qty,v.capital,v.date,html2]).draw();
        ...
        function filtergoldadvance(val,type){
            ...
            url: '{{route("backside.shop_owner.pos.platinum_advance_filter")}}',

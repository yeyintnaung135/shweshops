...
Route::group(['prefix' => 'backside/shop_owner', 'as' => 'backside.shop_owner.'], function () {
    ...
    Route::middleware(['auth:shop_owners_and_staffs'])->group(function () {
        ...
        Route::get('/get_return_list', [PosSecondPhaseController::class, 'get_return_list'])->name('pos.get_return_list');
        ...
        Route::delete('/delete_return/{return}', [PosSecondPhaseController::class, 'delete_return'])->name('pos.delete_return');
        ...
        Route::post('/datefilter_income', [PosSecondPhaseController::class, 'datefilter_income'])->name('pos.datefilter_income');
        ...
        Route::post('/datefilter_stock', [PosSecondPhaseController::class, 'datefilter_stock'])->name('pos.datefilter_stock');

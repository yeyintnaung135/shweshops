                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-sm-6">
                                <h3 class="d-inline-block d-sm-none">{{$shop->name}}</h3>
                                <div class="col-12">
                                    <img src="{{url($shop->photoone)}}" class="product-image" alt="Product Image">
                                </div>
                                <div class="col-12 product-image-thumbs">
                                    <div class="product-image-thumb active"><img src="{{url($shop->photoone)}}"
                                                                                 alt="Product Image"></div>
                                    <div class="product-image-thumb"><img src="{{url($shop->phototwo)}}"
                                                                          alt="Product Image"></div>
                                    <div class="product-image-thumb"><img src="{{url($shop->photothree)}}"></div>

                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <h3 class="my-3 mt-sm-0">{{$shop->name}}</h3>
                                <p>{{$shop->title}}</p>
                                ...
                                <div class="py-2 px-3 mt-4">
                                    ...
                                    <div class="tab-content p-3" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="product-desc" role="tabpanel"
                                            aria-labelledby="product-desc-tab">  {{ $shop->description }}
                                        </div>   
                                    </div>
...
{{--                                </div>--}}
                        ...
                        <div class="row float-right mt-4 mt-sm-4" style="" >
                            <a href="{{route('backside.shops.edit',['shop' => $shop->id])}}" class="btn btn-lg btn-success"><span class="fa fa-edit"></span>&nbsp;&nbsp;Edit</a>&nbsp;&nbsp;&nbsp;&nbsp;
                           
                            <form action="{{route('backside.shops.destroy',$shop->id)}}" method="POST" class="d-inline-block" onsubmit="return confirm('Are you sure want to delete?')">

                                @csrf
                                @method('DELETE')
                                <button class="btn btn-lg btn-danger"><span class="fa fa-trash"></span>&nbsp;&nbsp;Delete</button>
                            </form>
                        </div>

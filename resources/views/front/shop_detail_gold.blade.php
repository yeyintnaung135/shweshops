...
<div id="page" class="site my-0 py-0" style="background-color: #fffdf4;">
    {{--MENU--}}
    {{-- end Menu--}}
    ...
    <div class="site-content-contain sop-font">
                ...
                <div class="row ms-lg-5 ms-1" style="min-height: 80px;">
                    <div class="col-12 col-lg-6 d-flex p-0">
                        ...
                        <div class="premium-logo-wrap">
                            ...
                            <img src="{{url('/images/directory/banner/Frame 926.png')}}" alt="" srcset="" class="premium-logo premium-logo-frame">
                        </div>
                        {{-- End Shop Logo --}}
                        ...
                        <div class="sop-font ps-lg-4 ps-2 pt-3 ">
                            ...
                            <div class="pt-1">
                                <div class="row g-0">
                                    <p class="premium-title premium-title-gold">
                                        {{$shop_data->shop_name}}
                ...
                <div class="d-flex justify-content-between ms-lg-5 ms-2" style="max-height: 60px;">
                    ...
                    <div class="d-flex flex-fill">
                        ...
                        {{-- Phone --}}
                            <div class="ps-2 flex-grow-1 flex-sm-grow-0">
                                ...
                                <a href="tel:{{$shop_data->main_phone}}" data-toggle="modal" data-target="#phone" class="sop-social btn px-3 px-lg-5 py-2 btn-premium-gold justify-content-center" id="phone-button">
                    ...
                    <div class="d-lg-flex d-none" style="margin-top:-30px;">
                        <div class="text-center position-relative" style="width:150px; ">
                            <div class="icon-bg text-center mx-auto icon-bg-gold" style="width:46px; height:46px;">
        ...
        <div class="show_breadcrumb d-none show_dev position-relative ">
            <div class="d-flex justify-content-evenly position-absolute confetti-container w-100 overflow-hidden">
                <img src="/images/directory/banner/Confetti.gif" class="" style="width: auto;">
                <img src="/images/directory/banner/Confetti.gif" class="d-md-inline d-none" style="width: auto;">
                <img src="/images/directory/banner/Confetti.gif" class="d-lg-inline d-none" style="width: auto;">
            </div>
            @if($allcatcount != "[]")
            ...
            <nav class="navbar navbar-expand-sm justify-content-between mb-3 px-md-3">
                <ul class="navbar-nav">
                    <li class="newest_nav nav-item active">
                        <a class="nav-link nav-link-gold text-center px-3" id="newest">Newest</a>
                    </li>
                    <li class="popular_nav nav-item">
                        <a class="nav-link nav-link-gold text-center px-3" id="popular" style="">Popular</a>
                    </li>
                    <li class="nav-item discount_nav">
                        <a class="nav-link nav-link-gold text-center px-3" id="discount_pannel">Discount</a>
                    </li>
                    {{-- <li class="nav-item shop_nav">
                        <a class="nav-link" id="official_store">Shops</a>
                    </li> --}}
                </ul>
                <a href="/see_all_for_shop/popular/{{$shop_data->id}}" class="icon-bg text-center icon-bg-gold d-sm-block d-none" style="width:40px; height:40px;">
...
<style>
    ...
    .btn-premium-gold:hover {
        color: #848282 !important;
        background-color: #fdf8d8 !important;
        border-color: #ffec82 !important;
    }

    .btn-premium-gold:focus, .btn-premium-gold.focus {
        color: #848282 !important;
        background-color: #fff1a6 !important;
        border-color: #ffec82 !important;
        box-shadow: 0 0 0 0.2rem #fdf8d880 !important;
    ...
    .category-bg-gold {
        ...
        box-shadow: 2px 4px 4px 0px #f3cf0185;
        border: 0.3px solid #fae476;
    }
    ...
    .icon-bg-gold {
        ...
        box-shadow: 3px 3px 3px 0px #fae476;
    }

    .icon-bg-gold:hover {
        box-shadow: 3px 3px 5px 0px #fabc76; !important;

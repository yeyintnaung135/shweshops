...
<div id="page" class="site my-0 py-0" style="background-color: #f8f8f8;">
    {{--MENU--}}
    {{-- end Menu--}}
    ...
    <div class="site-content-contain sop-font">
                ...
                <div class="row ms-lg-5 ms-1" style="min-height: 80px;">
                    <div class="col-12 col-lg-6 d-flex p-0">
                        ...
                        <div class="sop-font ps-lg-4 ps-2 pt-3 ">
                            ...
                            <div class="ps-3 pt-1">
                                <div class="row g-0">
                                    <p class="premium-title premium-title-platinum">
                                        {{$shop_data->shop_name}}
                                        {{-- Eaint Yadanar Phyo Diamond Gold & Jewellery --}}
                                        <img src="{{url('/images/directory/banner/Platinum_Mark.png')}}" alt="" srcset="" class="premium-badge ms-1">
                                    </p>
                                ...
                                <div class="d-flex mb-1">
                                    <div class="d-flex d-lg-none ms-2">
                                        <div class="d-flex text-center position-relative">
                                            <div class="icon-bg mx-auto icon-bg-platinum " style="width:24px; height:24px;">
                                                <i class="fa-regular fa-eye text-secondary text-platinum" style="font-size: 12px; margin-top:6px;"></i>
                                            </div>                   
                                            <p class="mt-1 ms-lg-3 ms-2 me-lg-4 me-3 text-platinum" style="font-size: 14px;">{{ $view_count }}</p>
                                        </div>
                                        <div class="d-flex text-center position-relative">
                                            <div class="icon-bg mx-auto icon-bg-platinum" style="width:24px; height:24px;">
                                                <i class="fa-regular fa-heart text-secondary" style="font-size: 12px; margin-top:6px;"></i>
                                            </div>
                                            <p class="mt-1 ms-lg-3 ms-2 me-lg-4 me-3 text-platinum" style="font-size: 14px;">{{ $favcount }}</p>             
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="d-flex justify-content-between ms-lg-5 ms-2" style="max-height: 60px;">
                    ...
                    <div class="d-flex flex-fill">
                        ...
                        {{-- Phone --}}
                            <div class="ps-2 flex-grow-1 flex-sm-grow-0">
                                ...
                                <a href="tel:{{$shop_data->main_phone}}" data-toggle="modal" data-target="#phone" class="sop-social btn px-3 px-lg-5 py-2 btn-premium-platinum justify-content-center" id="phone-button">
                                    <i class="sop-social-i fa-solid fa-phone pe-1 pe-md-2" style="margin-top:3px; color: #6F6F6F;"></i>
                                    <div class="sop-social-i" style="color: #6f6f6f">Call Now</div>
                                </a>
                                <!-- Phone Modal -->
                    ...
                    <div class="d-lg-flex d-none" style="margin-top:-30px;">
                        <div class="text-center position-relative" style="width:150px; ">
                            <div class="icon-bg text-center mx-auto icon-bg-platinum" style="width:46px; height:46px;">
                                <i class="fa-regular fa-eye text-platinum" style="margin-top:14px;"></i>
                            </div>
                            <p class="mt-3 text-platinum">
                                {{ $view_count }} 
                                <span class="text-platinum-2">
                                    Visitors
                                </span>
                            </p>
                        </div>
                        <div class="text-center d-md-inline d-none position-relative" style="width:150px;">
                            <div class="icon-bg text-center mx-auto icon-bg-platinum" style="width:46px; height:46px;">
                                <i class="fa-regular fa-heart mt-3 text-platinum" style="margin-top:14px;"></i>
                            </div>
                            <p class="mt-3 text-platinum">
                                {{$favcount}} 
                                <span class="text-platinum-2">
                ...
                <div class="contact-wrap ms-lg-5 ms-1">
                    ...
                    <div class="d-flex pt-4">
                        ...
                        <div class="ps-4 pt-1 flex-fill">
                            <div class="address-text d-inline"> {!! $shop_data->address !!}
                            </div>
                            @if(isset($shop_data->other_address) || !is_null($shop_data->other_address) || !empty($shop_data->other_address))
        ...
        <div class="show_breadcrumb d-none show_dev position-relative ">
            ...
            <div class="px-4 px-lg-5 mx-lg-3 mt-3">
                <div class="m-lg-5 m-1 pt-2 position-relative category-bg category-bg-platinum">
                    <img src="/images/directory/banner/Corner_1_Platinum.png" alt="" class="corner-kanote corner-kanote-1 d-none d-lg-block">
                        <div class="py-1">@include('layouts.frontend.allpart.shop_detail.categories_shop_details',['shop_data'=>$shop_data])</div>
                    <img src="/images/directory/banner/Corner_2_Platinum.png" alt="" class="corner-kanote corner-kanote-2 d-none d-lg-block">
                </div>
            </div>
            @endif
        </div>
            ...
            <nav class="navbar navbar-expand-sm justify-content-between mb-3 px-md-3">
                <ul class="navbar-nav">
                    <li class="newest_nav nav-item active">
                        <a class="nav-link nav-link-platinum text-center px-3" id="newest">Newest</a>
                    </li>
                    <li class="popular_nav nav-item">
                        <a class="nav-link nav-link-platinum text-center px-3" id="popular" style="">Popular</a>
                    </li>
                    <li class="nav-item discount_nav">
                        <a class="nav-link nav-link-platinum text-center px-3" id="discount_pannel">Discount</a>
                    </li>
                    {{-- <li class="nav-item shop_nav">
                        <a class="nav-link" id="official_store">Shops</a>
                    </li> --}}
                </ul>
                <a href="/see_all_for_shop/popular/{{$shop_data->id}}" class="icon-bg text-center icon-bg-platinum d-sm-block d-none" style="width:40px; height:40px;">
...
<style>
    ...
    .btn-premium-platinum {
        color: #fff !important; 
        background-color: #dfdfdf !important;
        border-color: #dfdfdf !important;
    }

    .btn-premium-platinum:hover {
        color: #fff !important;
        background-color: #cccccc !important;
        border-color: #cccccc !important;
    }

    .btn-premium-platinum:focus, .btn-premium-platinum.focus {
        color: #fff !important;
        background-color: #cccccc !important;
        border-color: #cccccc !important;
        box-shadow: 0 0 0 0.2rem #fdf8d880 !important;
    ...
    .icon-bg-platinum {
        ...
        box-shadow: 3px 3px 5px 0px #c5c5c5;
    }

    .icon-bg-platinum:hover {
        box-shadow: 3px 3px 5px 0px #adadad; !important;

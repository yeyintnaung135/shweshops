                        ...
                        <div class="col-7">
                            <div class="row d-flex">
                                ...
                                <a class="btn btn-m btn-color ml-3"
                                    href="{{ route('backside.shop_owner.pos.create_wg_purchase') }}">
                    ...
                    <div class="card mt-2">
                        ...
                        <div class="card-body">
                            ...
                            <div class=" table-responsive text-black">
                                <table class="table table-striped" id="whiteGoldPurchaseTable">
                                    <thead>
                                        <th>နံပါတ်</th>
                                        <th>​ရွှေဖြူအမည်</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            var whiteGoldPurchaseTable = $('#whiteGoldPurchaseTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    "url": "{{ route('backside.shop_owner.pos.get_wg_purchase_list') }}",
                    "data": function(d) {

                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                >
                                    {{
                                        this.validate_errors[0].stock_count.msg
                                    }}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            >
                                {{ this.validate_errors[0].description.msg }}
                            </div>
                        </div>
                        <!-- /.col -->
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        v-model="min_price"
                                        v-on:input="
                                            priceToWordLogic(min_price, 'min'),
                                ...
                                >
                                    ...
                                    <input
                                        ...
                                        v-model="max_price"
                                        v-on:input="
                                            priceToWordLogic(max_price, 'max'),
                                                discountchangewhenpricechange()
                                        "
                                ...
                                <div>
                                    <div v-if="this.price == 0">
                                        ...
                                        {{ this.discount.newmax }}) ({{
                                            fordismmprice(this.discount.newmin)
                                        }}-{{
                                            fordismmprice(this.discount.newmax)
                                        }})
                                    </div>
                                    <div v-else>

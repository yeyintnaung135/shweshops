            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('backside.shop_owner.pos.update_assign_whitegold_price',$assign_gold_price->id)}}" method="POST">
                           @csrf
                           <a href="{{route('backside.shop_owner.pos.assign_whitegold_list')}}"><h4 class="text-color mt-2">​<i class="fa fa-chevron-left" aria-hidden="true"></i> &nbsp;&nbsp;ရွှေဖြူဈေးသတ်မှတ်ခြင်း</h4></a>
                           <div class="col-3">
                   ...
                   @else
                   <div class="card-body">
                    <form action="{{route('backside.shop_owner.pos.store_assign_whitegold_price')}}" method="POST">
                       @csrf
                       <a href="{{route('backside.shop_owner.pos.assign_whitegold_list')}}"><h4 class="text-color mt-2">​<i class="fa fa-chevron-left" aria-hidden="true"></i> &nbsp;&nbsp;ရွှေဖြူဈေးသတ်မှတ်ခြင်း</h4></a>
                           <div class="col-3">
                            <label for="date" class="col-form-label">Choose Date</label>

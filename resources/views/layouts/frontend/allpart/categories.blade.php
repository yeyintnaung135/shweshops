                ...
                <div class="col-12">
                    <article class="post-wrapper">
                        <div class="text-center post-img">
                            <a class="" href="{{ url('see_by_categories/' . $acc->category_id) }}">


                                <img src="{{ url('test/forcategory/' . $acc->category_id . '.jpg') }}"
                                    style="dispaly:inline !important;width:76px !important;height:80px !important;border-radius:50% !important;"

<template>
  <div class="site-content">
    <div class="products default loading row g-2 g-md-3" style="padding-bottom: 12px">
      <div
        class="col-6 col-sm-4 col-md-3 col-lg-2 yk-fade"
        v-for="d in this.discountdata"
        :key="d.id"
      >
        <div class="ftc-product product mb-2" style="box-shadow: none !important">
          <a :href="host + '/' + d.WithoutspaceShopname + '/product_detail/' + d.id">
          ...
          <div class="post-img sop-img">
            <a
              ...
              :href="host + '/shop_detail/' + d.WithoutspaceShopname"
            >
              <div
              ...
              >
                <img
                  v-lazy="host + '/images/logo/thumbs/' + d.ShopName.shop_logo"
                  class="yk-hover-logo float-left"
                />
                <span> {{ d.ShopName.shop_name | strlimit(15, "..") }}</span>
              </div>
            </a>
            ...
            <a :href="host + '/' + d.WithoutspaceShopname + '/product_detail/' + d.id">
              <img :src="imgurl + d.CheckPhoto" class="sop-image-w-h" />
            </a>
          </div>
          <p style="color:#222 text-align:left;" class="my-2">{{ d.name }}</p>
      ...
      <div class="d-flex justify-content-center fa-3x mb-3 sop-sans">
        ...
        >
          <span class="fa fa-spinner" v-bind:class="{ 'fa-spin': togglespin }"></span>
          View More
        </button>
        <div v-else>
          <a
          ...
          <a
            style="color: white !important"
            :href="this.host + '/see_all_discount_for_shop/' + this.shopid"
            v-else
            class="btn btn-danger zh-button"
          >
            <span class="fa fa-arrow-circle-right"></span>
...
export default {
  ...
  methods: {
    loadmoreclick(e) {
      ...
      axios
        .get(this.host + "/get_discount_ajax/" + this.limit + "/" + this.shopid)
        .then((response) => {

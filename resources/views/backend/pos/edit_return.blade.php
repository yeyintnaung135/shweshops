                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('backside.shop_owner.pos.update_return',$return->id) }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-7">
                                        <h4 class="text-color mt-2">​<i class="fa fa-chevron-left" aria-hidden="true"
                                                onclick="back()"></i> &nbsp;&nbsp;​​အထည်​ဟောင်းဝယ်ယူမှု စာရင်းပြင်ဆင်ခြင်း</h4>
                                        <div class="col-4 mt-2">
                                            <label for="date" class="col-form-label">​နေ့စွဲ</label>
                                            <input type="date" name="date" value="{{$return->date}}"><br><br>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-5">
                                        <div class="row">
                                            <div class="col-6 form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" value="{{$return->customer_name}}" required>
                                            </div>
                                            <div class="col-6 form-group">
                                                <label for="phone">ဖုန်းနံပါတ်</label>
                                                <input type="text" name="phone" class="form-control" id="phone" value="{{$return->phone}}"
                                                    required>
                                            </div>
                                            <div class="col-12 form-group">
                                                <label for="addresss">​နေရပ်လိပ်စာ</label>
                                                <textarea id="" cols="30" rows="4" class="form-control" name="address">{{$return->address}}</textarea>
                                            </div>
                                            <div class="col-12 mt-2">
                                                <label for="remark">မှတ်ချက်ထည့်သွင်းရန်</label>
                                                <textarea name="remark" id="" cols="30" rows="5">{{$return->remark}}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-6 form-group">
                                                ...
                                                <select name="category_id" class="form-control" id="category_id" required>
                                                    <option value="{{$return->category_id}}">{{$return->category->mm_name}}</option>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row">
                                                    <div class="col-3 form-group">
                                                        <input type="number" step="0.01" name="product_gram" placeholder="Gram" id="product_gram" class="form-control" value="<?php echo explode('/',$return->product_gram_kyat_pe_yway)[0]; ?>" required>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row" >
                                                    <?php  $diamonds = explode(',',$return->diamonds);
                                                    $counts = explode(',',$return->counts);
                                                    $carrats = explode(',',$return->carrats);
                                                    $yaties = explode(',',$return->yaties);
                                                    $bes = explode(',',$return->bes); ?>
                                            ...
                                            <div class="col-6 form-group mt-4">
                                                ...
                                                <select name="product_type" id="" class="form-control">
                                                    <option value="{{$return->product_type}}">{{$return->product_type}}</option>
                                            ...
                                            <div class="col-6 form-group mt-4">
                                                ...
                                                <input type="number" name="gold_fee" class="form-control" id="gold_fee" value="{{$return->gold_fee}}">
                                            </div>
                                            <div class="col-12 form-group mt-4">
                                                ...
                                                <div class="image-upload-wrap py-3">
                                                    ...
                                                    <div class="drag-text">
                                                      <h6 class="mt-1"><img src="{{asset('/pos/return_photo/'.$return->photo)}}"  style="max-height: 100px;" id="preview-image-before-upload">ပုံ​ရွေးရန်</h6>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="row mt-4 offset-10">
                                    <button type="submit" class="btn btn-m btn-color text-center"><i
                                            class="fa fa-floppy-o mr-2" aria-hidden="true"></i>Update</button>
                                </div>
                            </form>

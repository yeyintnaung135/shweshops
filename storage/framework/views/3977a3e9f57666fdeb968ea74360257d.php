<script>
    ...
    $(document).ready(function() {
        ...
        $("#checkcodereg").click(function() {
            ...
            if (regdata.code == '') {
                ...
                axios.post(`<?php echo url('checkcodereg'); ?>`, regdata).then(response => {
        ...
        $("#sentName").click(() => {
            ...
            axios.post(`<?php echo url('updatename'); ?>`,
                regdata
            ).then(response => {
    ...
    $("#login").click(function() {
        axios.post(`<?php echo url('checkvalidate'); ?>`, {
    ...
    $("#register").click(function() {
        axios.post(`<?php echo url('checkvalidateregister'); ?>`, {
            'name': $("#userName").val(),
    ...
    $("#resendCode").click(() => {
        ...
        axios.post(`<?php echo url('resend_code'); ?>`, {
...
</script><?php /**PATH P:\xampp\htdocs\shweshops\resources\views/JsScripts/Front/login.blade.php ENDPATH**/ ?>
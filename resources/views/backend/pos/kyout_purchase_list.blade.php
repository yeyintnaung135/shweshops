        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <h6 class="mt-3 text-color mb-1">ဆိုင်လက်ကျန်ကြည့်ရှုရန်
                    ...
                    <select name="" id="f_counter" onchange="stockcheck(2,this.value)">
            ...
            <div class="col-5">
                ...
                <div class="card mt-2">
                    <?php $tot_g = 0;$tot_y=0;$tot_p=0;$tot_k=0;$tot_dy=0;$tot_dp=0;$tot_dk=0;
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-3 card" style="max-height: 70px;"><h6 class="text-color mt-2" >စုစု​ပေါင်းအ​ရေအတွက် &nbsp;&nbsp;&nbsp;<span id="tot_qty">{{count($purchases)}}</span></h6></div>
    ...
    <script type="text/javascript">
         function goldtypefilter(val){
            ...
            success:function(data){
                ...
                var tot_g = 0;var tot_y=0;var tot_p=0;var tot_k=0;var tot_dy=0;var tot_dp=0;var tot_dk=0;var count=0;
                $.each(data.data, function(i, v) {
                    ...
                    var url2 = '{{ route('backside.shop_owner.pos.detail_kyout_purchase', ':purchase_id') }}';
                    ...
                    dataTable.row.add([++i,v.gold_name,v.supplier.name,v.code_number,html1,v.stock_qty,v.quality.name,v.capital,v.date,html2]).draw();
                })
                $('#tot_qty').html(count);
                $('#tot_g').html(tot_g);
        ...
        function filtergoldadvance(val,type){
            ...
            url: '{{route("backside.shop_owner.pos.kyout_advance_filter")}}',

                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-3 form-group">
                                                <input type="number" step="0.01" name="product_gram" placeholder="Gram" id="product_gram" class="form-control"  value="<?php echo explode('/',$sale->purchase->product_gram_kyat_pe_yway)[0]; ?>" required>

                                            </div>
                                            <div class="col-3 form-group">
                                                <input type="number" step="0.01" name="product_kyat"  id="product_kyat" class="form-control"  placeholder="ကျပ်" value="<?php echo explode('/',$sale->purchase->product_gram_kyat_pe_yway)[1]; ?>">

                                            </div>
                                            <div class="col-3 form-group">
                                                <input type="number" step="0.01" name="product_pe" id="product_pe" class="form-control"  placeholder="ပဲ" value="<?php echo explode('/',$sale->purchase->product_gram_kyat_pe_yway)[2]; ?>">
                                            </div>
                                            <div class="col-3 form-group">
                                                <input type="number" step="0.01" name="product_yway" id="product_yway" class="form-control"  placeholder="ရွေး" value="<?php echo explode('/',$sale->purchase->product_gram_kyat_pe_yway)[3]; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">

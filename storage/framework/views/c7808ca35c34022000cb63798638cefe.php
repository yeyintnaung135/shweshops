...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(url('images/logo/favicon.gif')); ?>">
...
<body class="hold-transition sidebar-mini">
    ...
    <!-- CodeMirror -->
    <script src="<?php echo e(url('plugins/codemirror/codemirror.js')); ?>"></script>
    <script src="<?php echo e(url('plugins/codemirror/mode/css/css.js')); ?>"></script>
    <script src="<?php echo e(url('plugins/codemirror/mode/xml/xml.js')); ?>"></script>
    <script src="<?php echo e(url('plugins/codemirror/mode/htmlmixed/htmlmixed.js')); ?>"></script>


    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta2/dist/js/bootstrap.bundle.min.js"></script>
    <script src="https://unpkg.com/cropperjs"></script>
    <script src="<?php echo e(asset('js/tz.js')); ?>"></script>
...
<?php /**PATH P:\xampp\htdocs\shweshops\resources\views/backend/super_admin/layout.blade.php ENDPATH**/ ?>
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <img
                                                        :src="
                                                            host +
                                                            '/images/directory/banner/Kanote frame.png'
                                                        "
                                                    />
                                                </a>
                                            </div>
                                            ...
                                            >
                                                <div
                                                    class="sn-premium-ribbon text-center"
                                                ></div>
                                                <div class="sn-premium-text">
                                                    Premium<br />Shop
                                                </div>
                                            </div>
                                            <a
    ...
    methods: {
        changeState() {
            ...
            return new Promise((resolve, response) => {
                axios
                    .get(
                        this.host +
                            "/get_township_bystate/" +
                            this.selected_state
                    )
                    .then((response) => {
                        this.townships = response.data;
                        if (
                            localStorage.getItem("selected_township") ==
                            undefined
                        ) {
        ...
        searchbyFilter() {
            localStorage.setItem(
                "selected_state",
                this.selected_state.toString()
            );
            localStorage.setItem(
                "selected_township",
                this.selected_township.toString()
            );

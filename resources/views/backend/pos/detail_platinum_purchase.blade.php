        ...
        <section class="content-header">
            <div class="container-fluid">
                ...
                <div class="row mt-3">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    <div class="col-7">
                                        <div class="row">
                                            <div class="col-4">
                                              ...
                                              <h6 class="mt-4">​ပလက်တီနမ်အရည်အသွေး</h6>
                                              <h6 class="mt-4">​ပလက်တီနမ်အမျိုးအစား</h6>
                                            ...
                                            <div class="col-7">
                                              ...
                                              <h6 class="text-color mt-4">{{$purchase->platinum_name}}</h6>
                                              <h6 class="text-color mt-4">{{$purchase->quality}}</h6>
                                              <h6 class="text-color mt-4">{{$purchase->platinum_type}}</h6>
                                    ...
                                    @else
                                    <img src="{{filedopath('/pos/platinumpurchase_photo/'.$purchase->photo)}}"/>
                                    @endif
                    ...
                    <div class="col-1">
                        <a href="{{route('backside.shop_owner.pos.edit_ptm_purchase',$purchase->id)}}" class="ml-2 mt-4 btn btn-sm btn-warning text-white"><i class="fa fa-pencil" ></i></a><br>
            ...
            // alert(id);
                $.ajax({
                    ...
                    success:function(data){
                        // window.open('https://test.shweshops.com/backside/shop_owner/ptmpurchase_list');
                        window.location.href = "{{ route('backside.shop_owner.pos.ptm_purchase_list')}}";
                    }
                })

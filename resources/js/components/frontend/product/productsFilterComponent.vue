<template>
  <div>
    <div
      ...
      style="position: relative !important; margin-top: 36px; height: 560px"
    >
    ...
    <div class="container-fluid px-1" v-if="!this.showbigloader">
      <div class="mb-3 col-12 mt-3">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            <div class="state-dropdown">
              ...
              <label for="toggle2" class="animate"
                >{{
                  this.state_label ? this.state_label + "ဆိုင်များ" : "ဆိုင်များအားလုံး"
                }}
                <i class="fas fa-chevron-down"></i
              ></label>
              <ul class="animate p-0">
                <li class="animate" value="all" @click="filterShop()">
                  ဆိုင်များအားလုံး
                </li>
                <li
                  class="animate"
          ...
          <button class="p-2 filter-button d-block d-md-none" @click="showFilter">
              ...
              <article class="post-wrapper">
                <div id="cato_slide" class="post-img sop-cato-img">
                  <input
                    ...
                    @change="checkedSelectedShop(), checkedF(), removeSelectOther()"
                    class="shop-icon"
                  />
                  <label for="allshop" class="px-1 px-md-2 mb-0">
                    <img
                      :src="host + '/test/img/allshops.png'"
                ...
                <div class="post-info">
                  <div class="mt-2 sop-font-content text-center w-100">
                    <p class="sop-item-count mb-2">All Shops</p>
                    <span class="textsmall"> (ဆိုင်အားလုံး) </span>
                  </div>
                </div>
              </article>
            </div>
            <div v-for="f in this.shoplist" :key="f.id" class="shop-count">
              <article class="post-wrapper">
                <div id="cato_slide" class="post-img sop-cato-img">
                  <input
                    type="checkbox"
                    ...
                    :id="f.id"
                    v-model="byspecificshop"
                    @change="checkedF(), checkedSelectedShop()"
                    class="shop-icon"
                  />
                  <label :for="f.id" class="px-1 px-md-2 mb-0">
                    <img
                      :src="host + '/images/logo/mid/' + f.shop_logo"
                      class="attachment-ftc_blog_shortcode_thumb size-ftc_blog_shortcode_thumb wp-post-image lazyloaded sop-image"
                      alt=""
                    />
                  </label>
                ...
                <div class="post-info">
                  <div class="mt-2 sop-font-content text-center w-100">
                    ...
                    <span v-if="f.shop_name_myan" class="sop-textsmall"
                      >({{ f.shop_name_myan | strlimit(20, "..") }})</span
                    >
                  </div>
                </div>
              </article>
      ...
      <div class="row container-fluid p-0 m-0">
        <div class="col-3 mb-2 position-absolute sorting-filter">
          <div class="position-relative">
            ...
            >
              ...
              <option v-if="this.isdiscount == 'yes'" value="discountpercent">
                Discount Percent
              </option>
            </select>
          </div>
        ...
        <div class="d-none d-md-block col-12 col-md-3 pe-md-3 pe-lg-5 filter-container">
          <div class="filter-sticky">
            <button @click="hideFilter" class="d-block d-md-none filter-close-button">
            ...
            <div class="col-12 mb-2 mt-2">
              <div class="sn-price-range">
                ...
                >
                  <span class="sn-price-error" v-if="error_message"
                  ...
                  <input
                    ...
                    @click="togglepriceoptionshow($event, 'from')"
                    @input="snPriceCheck"
                    v-bind:class="{
                  ...
                  >
                    <div yk-value="50000" @click="getfrompricedata($event, 'from')">
                      ၅ သောင်း
                    </div>
                    <div yk-value="100000" @click="getfrompricedata($event, 'from')">
                      ၁ သိန်း
                    </div>
                    <div yk-value="500000" @click="getfrompricedata($event, 'from')">
                      ၅ သိန်း
                    </div>
                    <div yk-value="1000000" @click="getfrompricedata($event, 'from')">
                      ၁၀ သိန်း
                    </div>
                    <div yk-value="5000000" @click="getfrompricedata($event, 'from')">
                      သိန်း ၅၀
                    </div>
                    <div yk-value="10000000" @click="getfrompricedata($event, 'from')">
                      သိန်း ၁၀၀
                    </div>
                    <div yk-value="50000000" @click="getfrompricedata($event, 'from')">
                      သိန်း ၅၀၀
                    </div>
                  </div>
                  <div class="arrow"></div>
                </div>
                <div class="sn-to-price" v-click-outside="toPriceBoxBlur">
                  <input
                    type="number"
                    min="0"
                    ...
                    @click="togglepriceoptionshow($event, 'to')"
                    @input="snPriceCheck"
                  />
                  <div
                    class="sn-price-list form-control shadow-none position-absolute p-0"
                  ...
                  >
                    <div yk-value="50000" @click="getfrompricedata($event, 'to')">
                      ၅ သောင်း
                    </div>
                    <div yk-value="100000" @click="getfrompricedata($event, 'to')">
                      ၁ သိန်း
                    </div>
                    <div yk-value="500000" @click="getfrompricedata($event, 'to')">
                      ၅ သိန်း
                    </div>
                    <div yk-value="1000000" @click="getfrompricedata($event, 'to')">
                      ၁၀ သိန်း
                    </div>
                    <div yk-value="5000000" @click="getfrompricedata($event, 'to')">
                      သိန်း ၅၀
                    </div>
                    <div yk-value="10000000" @click="getfrompricedata($event, 'to')">
                      သိန်း ၁၀၀
                    </div>
                    <div yk-value="50000000" @click="getfrompricedata($event, 'to')">
                      သိန်း ၅၀၀
                    </div>
                  </div>
                  <div class="arrow"></div>
            ...
            <div class="col-12 mb-2 mt-2 sn-radio-filter">
              <label class="sn-label" for="">Product Qualities</label>
              <radio
              ...
              <button @click="qseemore()" class="d-block seemorebtn">
                {{ this.seemoretext }}
              </button>
            </div>
            ...
            <div class="col-12 mb-2 mt-2">
              ...
              <button @click="catSeeMore()" class="d-block" id="cat-more-btn">
                See more...
              </button>
            </div>
            ...
            <div class="col-12 mb-2 mt-2 gems-container">
              ...
              >
                <checkbox
                  ...
                  @input="setGems()"
                >
                  <span class="gem-checked-icon position-absolute"
              ...
              <button @click="gemsSeeMore()" class="d-block" id="gems-more-btn">
                See more...
              </button>
            </div>
            ...
            <button class="d-block d-md-none filter-save" @click="hideFilter">
              Save
            </button>
          </div>
        </div>
...
export default {
  ...
  beforeMount() {
    ...
    this.notnullcatlist = this.cat_list.filter((f) => f.category_id != null);
...
if(this.gender != undefined){
  this.selectedgender=this.gender;
    ...
    if (localStorage.getItem("product_quality") != undefined) {
      this.selected_product_quality = localStorage.getItem("product_quality");
    } else {
    ...
    if (localStorage.getItem("specific_cat_id") != undefined) {
      this.specific_cat_id = JSON.parse(localStorage.getItem("specific_cat_id"));
    }
    if (localStorage.getItem("byspecificgems") != undefined) {
      this.byspecificgems = JSON.parse(localStorage.getItem("byspecificgems"));
    }
  ...
  methods: {
    ...
    filterShop: function (state_name, state_id) {
      ...
      if (!state_name && !state_id) {
        ...
        axios.get(this.$hostname + "/getshopbystate/" + state_id).then((response) => {
    ...
    checkedF: function () {
      ...
      } else if (this.byspecificshop.length >= 2 && this.byspecificshop.includes("all")) {
      ...
      if (
        ...
        for (var i = 0; i < this.byspecificshop.length; i++) {
          document.getElementById(this.byspecificshop[i]).checked = false;
        }
        this.byspecificshop = ["all"];
        document.getElementById("allshop").checked = true;
        this.byshop = ["all"];
    ...
    snPriceCheck: function () {
      ...
      if (this.to_price != "" && parseInt(this.from_price) > parseInt(this.to_price)) {
        this.error_message = true;
      } else if (this.from_price != "" && this.to_price != "") {
        this.error_message = false;
        localStorage.setItem("price_range", this.from_price + "-" + this.to_price);
    ...
    setCategory: function () {
      localStorage.setItem("specific_cat_id", JSON.stringify(this.specific_cat_id));
      this.showbigloader = true;
    ...
    // Gems
    setGems: function () {
      localStorage.setItem("byspecificgems", JSON.stringify(this.byspecificgems));
      this.showbigloader = true;
      this.$refs.productcom.shownoitems = false;
    ...
    getGender: function () {
      ...
      this.$refs.productcom.shownoitems = false;
      localStorage.setItem("product_quality", this.selected_product_quality);
      this.getdatafromserver_bysort();
    },

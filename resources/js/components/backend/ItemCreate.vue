                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    >
                                        {{
                                            this.validate_errors[0].product_code
                                                .msg
                                        }}
                                    </div>
                                </div>
...
import validatecreate from "./services/validateitemcreate";
...
export default {
    ...
    mounted() {
        ...
        console.log("fefe");
        console.log(this.percenttemplate);
            ...
            if (this.validate_errors.length > 0) {
                if (fieldname == "stock_count") {
                    ...
                    if (
                        ...
                        return true;
                    }else if(this.validate_errors[0][fieldname] &&
                       ( Number(this.price) == 0 && (Number(this.min_price) > Number(this.max_price)
                    ))){
        ...
        percenttemplateChange($event) {
            this.percenttemplate.forEach((percenttemplate) => {
                if (percenttemplate.id == this.percenttemplate_id) {
                    // this.handmade = percenttemplate.handmade;
                    // this.charge = percenttemplate.charge;

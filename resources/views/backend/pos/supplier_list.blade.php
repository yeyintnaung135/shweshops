                                ...
                                <td>{{$supplier->date}}</td>
                                 <td>
                                    <div class="d-flex">
                                        ...
                                        <a href="{{route('backside.shop_owner.pos.edit_supplier',$supplier->id)}}" class="ml-4 text-warning"><i class="fa fa-edit" ></i></a>
        ...
        function typefilter(val){
            ...
            success:function(data){
                ...
                $.each(data, function(i, v) {
                    ...
                    dataTable.row.add([++i,v.shop_name,v.shop_type,v.code_number,v.name,v.phone,v.other_phone,v.date,html1]).draw(); 
                })   
                }
            })
        }

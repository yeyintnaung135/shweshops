...
@push('scripts')
    <script>
        var customersTable = $('#superAdminTable').DataTable({
            ...
            serverSide: true,
            ajax: {
                'url': "{{ url('/backside/shop_owner/get_orders') }}",
                'data': function(data) {
                    // Read values
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data) {
                        var detail = `
                      <a href="{{ url('backside/shop_owner/orders/detail/:id') }}" role="button" class="btn btn-sm btn-warning" data-toggle="tooltip" data-placement="top" title="Shop Detail">
                        <i class="fa fa-eye"></i>
                      </a>
                    `;

...
@push('scripts')
    <script>
         function ptmtypefilter(val){
            ...
            url: '{{route("backside.shop_owner.pos.ptmsale_type_filter")}}',
            ...
            success:function(data){
                ...
                $.each(data.data, function(i, v) {
                    ...
                    var url1 = '{{ route('backside.shop_owner.pos.edit_ptmsale', ':purchase_id') }}';
                    url1 = url1.replace(':purchase_id', v.id);
                    var url2 = '{{ route('backside.shop_owner.pos.detail_ptmsale', ':purchase_id') }}';
                    ...
                    dataTable.row.add([++i,v.purchase.platinum_name,v.purchase.code_number,1,v.amount,v.purchase.product_gram,v.date,html2]).draw();
                })
                $('#tot_qty').html(count);
                $('#tot_g').html(tot_g);
        ...
        function filtergoldadvance(val,type){
            ...
            url: '{{route("backside.shop_owner.pos.platinumsale_advance_filter")}}',

                ...
                <div class="card">
                    <div class="card-body">
                        {{-- <span class="offset-5  mt-2 font-weight-bold" style="font-size:19px;">Create Purchase Form (ရွှေ)</span> --}}
                         <form action="{{route('backside.shop_owner.pos.update_sale_kyout',$sale->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-7">
                                ...
                                <div class="row">
                                    <div class="col-6 form-group">
                                        ...
                                        <select name="purchase_id" id="" onchange="fillValues(this.value)"  class="form-control select2" required>
                                            <option value="{{$sale->purchase_id}}">{{$sale->purchase->code_number}}-{{$sale->purchase->gold_name}}</option>
                                            @foreach ($purchases as $purchase)
                                            <option value="{{$purchase->id}}">{{$purchase->code_number}}-{{$purchase->gold_name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-6 form-group">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-3 form-group">
                                                <input type="number" step="0.01" name="product_gram" placeholder="Gram" id="product_gram" class="form-control"  value="<?php echo explode('/',$sale->purchase->gold_gram_kyat_pe_yway)[0]; ?>" required>

                                            </div>
                                            <div class="col-3 form-group">
                                                <input type="number" step="0.01" name="product_kyat"  id="product_kyat" class="form-control"  placeholder="ကျပ်" value="<?php echo explode('/',$sale->purchase->gold_gram_kyat_pe_yway)[1]; ?>">

                                            </div>
                                            <div class="col-3 form-group">
                                                <input type="number" step="0.01" name="product_pe" id="product_pe" class="form-control"  placeholder="ပဲ" value="<?php echo explode('/',$sale->purchase->gold_gram_kyat_pe_yway)[2]; ?>">
                                            </div>
                                            <div class="col-3 form-group">
                                                <input type="number" step="0.01" name="product_yway" id="product_yway" class="form-control"  placeholder="ရွေး" value="<?php echo explode('/',$sale->purchase->gold_gram_kyat_pe_yway)[3]; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        ...
                                        <div class="row">
                                            <div class="col-3 form-group">
                                                <input type="number" step="0.01" name="diamond_gram" placeholder="Gram" id="diamond_gram" class="form-control"  value="<?php echo explode('/',$sale->purchase->diamond_gram_kyat_pe_yway)[0]; ?>" required>

                                            </div>
                                            <div class="col-3 form-group">
                                                <input type="number" step="0.01" name="diamond_kyat"  id="diamond_kyat" class="form-control"  placeholder="ကျပ်" value="<?php echo explode('/',$sale->purchase->diamond_gram_kyat_pe_yway)[1]; ?>">

                                            </div>
                                            <div class="col-3 form-group">
                                                <input type="number" step="0.01" name="diamond_pe" id="diamond_pe" class="form-control"  placeholder="ပဲ" value="<?php echo explode('/',$sale->purchase->diamond_gram_kyat_pe_yway)[2]; ?>">
                                            </div>
                                            <div class="col-3 form-group">
                                                <input type="number" step="0.01" name="diamond_yway" id="diamond_yway" class="form-control"  placeholder="ရွေး" value="<?php echo explode('/',$sale->purchase->diamond_gram_kyat_pe_yway)[3]; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                            ...
                            <div class="offset-1 col-5">
                                <div class="row">
                                    ...
                                    <div class="col-12 mt-4">
                                        ...
                                        <input type="hidden" name="" id="gold_price" value="{{$sale->purchase->gold_price}}">
                                    </div>
                                    ...
                                    <div class="col-6 form-group" style="margin-top:25px;">
                                        ...
                                        <input type="text" name="diamond_fee" id="diamond_fee" class="form-control" value="{{$sale->purchase->diamond_selling_price}}" required>
                                    </div>
                                    <div class="col-6 form-group" style="margin-top:25px;">

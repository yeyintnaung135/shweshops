<header id="masthead" class="site-header ">
    ...
    <div class="ftc-header-template header-ftc-element">
        <div class="header-mobile" style="height:62px !important;">
            ...
            <?php if(isset(Auth::guard('web')->user()->id) || isset(Auth::guard('shop_owners_and_staffs')->user()->id)): ?>
            ...
            <div class="ftc-cart-element is-mobile">
                ...
                <div class="ftc-tini-cart">
                    <div class="cart-item">
                        <a href="<?php echo e(url('myfav/see_all')); ?>">
                                        ...
                                        <div class="elementor-element elementor-element-46ef4145 elementor-widget elementor-widget-ftc_shooping_cart"
                                            ...
                                            <div class="elementor-widget-container">
                                                <div class="ftc-cart-element text-center">
                                                    ...
                                                    <div class="ftc-tini-cart">
                                                        <div class="cart-item">
                                                            <a href="<?php echo e(url('mycart/see_all')); ?>">
                                                                <div class="cart-total">
...
<?php $__env->stopPush(); ?>
<?php /**PATH P:\xampp\htdocs\shweshops\resources\views/layouts/frontend/allpart/menu.blade.php ENDPATH**/ ?>
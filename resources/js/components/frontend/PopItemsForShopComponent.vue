<template>
  <div class="site-content sop-font">
    <div class="products default loading row g-2 g-md-3 d-flex" style="padding-bottom: 12px">
      <div
        ...
        :key="item.id"
      >
        <div class="ftc-product mb-2" style="box-shadow: none !important;">
          <div class="post-img sop-img">
            ...
            >
              ...
              <!-- <img
                :src="host+'/images/items/1680586452732_1672228050136_1669190915524_147.jpg'"
                class="sop-image-w-h w-sm-100 rounded"
              /> -->
            </a>
          </div>
      ...
      <div class="d-flex justify-content-center w-100 fa-3x mb-3">
        <button
          v-if="this.clickloadmorecount < 5 && this.forcheck_count != 0"
          id=""
        ...
        <a
          ...
          :href="this.host + '/see_all_for_shop/popular/' + this.newdata[0].shop_id"
          class="btn btn-danger sop-view-button"
          @click="test"
        >
...
export default {
  ...
  methods: {
    loadmoreclick(e) {
      ...
      axios
        .get(
          this.host + "/" + this.uri + "/" + this.latestid + "/" + this.newdata[0].shop_id
        )
        .then((response) => {

            ...
            <section class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="row mt-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-3">
                                                ...
                                                <div class="col-12">
                                                    <table cellspacing="0" cellpadding="0" style="border: none;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>-</td>
                                                            <td><span class="text-color ">{{ $profit[0] }} {{ $profit[1] }} ကျပ်</span>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td style="border: none;">ရွှေဖြူအမည်</td>
                                                            <td>-</td>
                                                            <td><span class="text-color ">
                                                                    {{ $purchase->name }}</span> 
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td style="border: none;">ရွှေဖြူအရည်အသွေး</td>
                                                            <td>-</td>
                                                            <td><span class="text-color ">
                                                        ...
                                                        <tr>
                                                            <td style="border: none;">ရွှေဖြူအမျိုးအစား</td>
                                                            <td>-</td>
                                                            <td><span class="text-color ">
                                        ...
                                        <div class="col-5">
                                            ...
                                            @else
                                                <img
                                                    src="{{ filedopath('/pos/whitegoldpurchase_photo/' . $purchase->photo) }}" />
                                            @endif
                        ...
                        <div class="col-1">
                            <a href="{{ route('backside.shop_owner.pos.edit_wg_purchase', $purchase->id) }}"
                            ...
                            @if ($purchase->sell_flag == 0)
                                <a class="btn btn-sm btn-danger text-white mt-3 ml-2"
                                    onclick="Delete('{{ route('backside.shop_owner.pos.delete_wg_purchase', ['purchase' => $purchase]) }}')">

...
<head>
    ...
    <link rel="manifest" href="<?php echo e(url('shweshopsaddtohomescreen.webmanifest')); ?>" />
    ...
    <?php if(Auth::check()): ?>
        <script>
            window.userid = <?php echo e(\Illuminate\Support\Facades\Auth::user('guard')->id); ?>;
        </script>
    <?php endif; ?>
    <?php
    ...
    <link rel="icon" type="image/png" sizes="18x18" href="<?php echo e(url('images/logo/favicon.gif')); ?>">
    <link rel='stylesheet' href="<?php echo e(url('test/css/normalize.css')); ?>" type='text/css' />
    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="<?php echo e(url('plugins/google/fortestgoogle.js')); ?>"></script>
    <script>
    ...
    <link rel='stylesheet' id='jquery-ui-style-css' href="<?php echo e(url('test/css/forfoot.css')); ?>" type='text/css'
        media='all' />
    ...
    * ---------------------------------------------- */
    ...
    <link rel='stylesheet' id='ftc-element-css'
        href="<?php echo e(url('test/wp-content/plugins/themeftc-for-elementor/assets/css/default.css')); ?>" type='text/css'
        media='all' />

    <link rel='stylesheet' id='mmm_mega_main_menu-css'
        href="<?php echo e(url('test/wp-content/plugins/mega_main_menu/src/css/cache.skin.css')); ?>" type='text/css'
        media='all' />

    <link rel='stylesheet' id='jquery-ui-style-css'
        href="<?php echo e(url('test/wp-content/plugins/woocommerce/assets/css/jquery-ui/jquery-ui.min.css')); ?>" type='text/css'
        media='all' />

    <link rel='stylesheet' id='select2_css-css'
        href="<?php echo e(url('test/wp-content/plugins/wc-frontend-manager/includes/libs/select2/select2.css')); ?>"
        type='text/css' media='all' />
    <link rel='stylesheet' id='font-awesome-css' href="<?php echo e(url('fonts/css/all.min.css')); ?>" type='text/css'
        media='all' />

    <link rel='stylesheet' id='ftc-style-css' href="<?php echo e(url('test/wp-content/themes/karo1/style.css')); ?>"
        type='text/css' media='all' />
    ...
    <link rel='stylesheet' id='ftc-responsive-css'
        href="<?php echo e(url('test/wp-content/themes/karo1/assets/css/responsive.css')); ?>" type='text/css' media='all' />
    <script type='text/javascript' src="<?php echo e(url('test/js/jquery.latest.js')); ?>" id='jquery-core-js'></script>


    <link rel='stylesheet' id='elementor-frontend-css'
        href="<?php echo e(url('test/wp-content/plugins/elementor/assets/css/frontend.css')); ?>" type='text/css' media='all' />
    


    <link rel='stylesheet' id='jquery-ui-style-css' href="<?php echo e(url('test/css/bootstrap.css')); ?>" type='text/css'
        media='all' />


    
    <script src="<?php echo e(url('test/js/bootstrap-multi.js')); ?>"></script>
    <link rel="stylesheet" href="<?php echo e(url('test/css/bootstrap-multiselect.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(url('test/css/fancybox.css')); ?>" />
    <style>
        .header-content {
            padding: 11px 0;
        }
        ...
        .directory-banner {
            background-image: url("<?php echo e(asset('images/directory/banner/shopdirectorybanner.jpg')); ?>");
...
<body onbeforeunload="useroffline()"
    ...
    <div id="app">
        ...
        <div>
           Guset ID <?php echo e(session()->get('guest_id')); ?>

        </div>
      
        <?php endif; ?>

        <?php if(\Illuminate\Support\Facades\Auth::guard('web')->check()): ?>
            <?php if($is_chat_on == 'on'): ?>
                <chat-wrapper ref='chatlistref' v-on:getfromid="getfromidparent"
                    v-bind:userid="<?php echo e(\Illuminate\Support\Facades\Auth::user()->id); ?>"></chat-wrapper>

                <chat-template ref="chatref" v-on:openmain="toopenmainchatwrapper"
                    v-bind:userid="<?php echo e(\Illuminate\Support\Facades\Auth::user()->id); ?>"
                    v-bind:username="'<?php echo e(\Illuminate\Support\Facades\Auth::user()->username); ?>'"></chat-template>
            <?php endif; ?>
        <?php endif; ?>
                        ...
                        <div class="d-flex flex-row">
                            <div>
                                <img style="width: 100px;height:100px;"
                                    src="<?php echo e(url('images/items/mid/16527968693160ab7b693-35b2-46e4-85cf-500cae96b99b.jpeg')); ?>"
                                    id="noti_img">
                            </div>
                            <div class="pl-2">
        ...
        <?php echo $__env->make('front.addtohome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        ...
        var cururl = '<?php echo e(url()->current()); ?>';
    ...
    <script type='text/javascript'
        src="<?php echo e(url('test/wp-content/plugins/wc-frontend-manager/includes/libs/select2/select2.js')); ?>" id='select2_js-js'>
    </script>


    <script type='text/javascript' src="<?php echo e(url('test/js/owl.js')); ?>" id='owl-carousel-js'></script>
    <script src='<?php echo e(url('test/js/owl.thumbs.js')); ?>'></script>




    <?php if(session()->has('show_add_to_home')): ?>
        <script>
        ...
        <script>
            function updateaddtohome() {
                return new Promise(resolve => {
                    axios
                        .post(
                            "<?php echo e(url('/addtohome/update')); ?>", {
                                data: {
                                    addtohs: 'yes'
            ...
            if ('serviceWorker' in navigator) {
                navigator.serviceWorker
                    .register("<?php echo e(url('swath.js')); ?>")
                    .then(() => {
    ...
    <?php if(\Illuminate\Support\Facades\Session::has('logined')): ?>
        <script>
            const upload_fav_localstorage_to_server_after_logined = function(data) {
                if (typeof localStorage.getItem(data) !== 'undefined' && localStorage.getItem(data) !== null) {
                    ...
                    return new Promise((resolve, reject) => {
                        let uri = "<?php echo e(url('/myfav/upload_after_logined')); ?>";
                        if (data == 'cart') {
                            uri = "<?php echo e(url('/mycart/upload_after_logined')); ?>";
                        }
                        axios.post(uri, {
    ...
    <?php echo $__env->yieldPushContent('favourite'); ?>
    ...
    <script src="<?php echo e(url('test/js/firebase/firebase-app.js')); ?>"></script>
    <script src="<?php echo e(url('test/js/firebase/firebase-messaging.js')); ?>"></script>
...
<?php /**PATH P:\xampp\htdocs\shweshops\resources\views/layouts/frontend/frontend.blade.php ENDPATH**/ ?>
                         ...
                         <div class="row mt-5">
                            ...
                            <div class="col-3 form-group">
                                ...
                                <select name="supplier_id" class="form-control" required>
                                    <option value="">ပန်းထိမ်ဆိုင်</option>
                            ...
                            {{-- <div class="col-3 form-group"> --}}
                                ...
                                <select name="diamond_id" id="diamond_id" class="form-control">
                                    ...
                                    <option value="{{$diamond->id}}">{{$diamond->diamond_name}}</option>
                                    @endforeach
                                </select> --}}
                            {{-- </div> --}}
                            {{-- <div class="col-3 form-group"> --}}
                            ...
                            <div class="col-6 mt-5">
                                <div class="form-check form-check-inline">
                                  ...
                                  <div class="form-check form-check-inline">
                                    <input class="form-check-input" checked type="radio" id="inlineCheckbox" name='inlineCheckbox' value="option3"/>
    ...
    <script>
        ...
        function check_barcode(){
            if($('#print_barcode').is(':checked')){
                ...
                var kyat = $('#gold_kyat').val();
                var pe = $('#gold_pe').val();
                var yway = $('#gold_yway').val();
                var dgram = $('#diamond_gram').val();
                var dkyat = $('#diamond_kyat').val();
                var dpe = $('#diamond_pe').val();
                var dyway = $('#diamond_yway').val();
                ...
                if(code == '' || gram == ''){
                    ...
                    $('#text').val(code+'-'+gram+'-'+kyat+'-'+pe+'-'+yway+'-'+dgram+'-'+dkyat+'-'+dpe+'-'+dyway);

            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-9">
                                <span class="text-color" style="font-size:19px;">​ရွှေဖြူ​စျေးနှုန်းများ</span>
                            </div>
                            <div class="col-3">
                        ...
                        <a href="{{route('backside.shop_owner.pos.assign_whitegold_price')}}" class="btn btn-m btn-color float-right mt-3">Update</a>
                        @else
                        <div class="row">
                            <div class="col-9">
                                <span class="text-color" style="font-size:19px;">​ရွှေဖြူ​စျေးနှုန်းများ</span>
                        ...
                        <a href="{{route('backside.shop_owner.pos.assign_whitegold_price')}}" class="btn btn-m btn-color float-right mt-3">Create</a>
                        @endif
                    </div>
...
@push('css')
    <style>
        ...
        .card-color{
            background-color: rgb(223, 204, 100);
        }
        .card-color1{
            background-color: rgb(223, 204, 100);
        }

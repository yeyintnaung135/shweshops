                                    ...
                                    <div class="d-flex justify-content-end my-3 align-items-center">
                                        <div class="form-group mr-md-2">
                                            <fieldset>
                                                ...
                                                <input type="text" id='search_fromdate_itemact'
                                                    class="itemactdatepicker form-control" placeholder='Choose date'
                                                    autocomplete="off" />
                                            </fieldset>
                                        </div>
                                        <div class="form-group mr-md-2">
                                            <fieldset>
                                                ...
                                                <input type="text" id='search_todate_itemact'
                                                    class="itemactdatepicker form-control" placeholder='Choose date'
                                                    autocomplete="off" />
                                            </fieldset>
                                        </div>
                                        <div class="pr-md-4">
                                            <input type='button' id="itemact_search_button" value="Search"
                                                class="btn bg-info">
                                        </div>
                                    </div>
        ...
        $(document).ready(function() {
            ...
            var itemsActivityTable = $('#itemsActivityTable').DataTable({
                ...
                ajax: {
                    ...
                    'data': function(data) {
                        // Read values
                        var from_date = $('#search_fromdate_itemact').val() ? $(
                            '#search_fromdate_itemact').val() + " 00:00:00" : null;

    ...
    <div id="" class="sop-font px-md-3">
        ...
        <div class="mt-4 elementor-element elementor-element-3205fef1 elementor-widget elementor-widget-heading">
            <div class="elementor-widget-container d-flex justify-content-between align-items-center">
                <h3 class="mb-3 elementor-heading-title elementor-size-default mx-0 pt-3" style="font-family: sans-serif!important">News & Events</h3>
                <a href="{{ url('/news') }}" class="icon-bg text-center d-sm-block d-none 
                ...
                <div class="ftc-product product">
                    ...
                    <div class="card" style="width: 100%">
                        <a href="{{ url($ne->type . '/p/' . $ne->id . '/' . $ne->shop_id)}}">
                            @if($ne->type == "events")
                                <img class="card-img-top sop-image-w-h sop-img n-e-img" src="{{ filedopath('/shop_owner/events/' . $ne->photo) }}" alt="Card image cap">
                            @elseif($ne->type == "news")
                                <img class="card-img-top sop-image-w-h sop-img n-e-img" src="{{ filedopath('/shop_owner/news/' . $ne->image) }}" alt="Card image cap">
                            @endif
                        </a>
                    </div>

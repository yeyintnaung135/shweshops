<template>
    ...
    >
        <slick ref="shopslick" :options="slickOptions">
            <div
                class="all_nav shop-item"
                :class="{ shop_active: this.activeItem == 'all' }"
            >
                <a class="shop-link" id="all" @click.prevent="setActive('all')"
                    >အားလုံး</a
                >
            </div>
            <div
                class="shop-item popular_nav"
                :class="{ shop_active: this.activeItem == 'popular' }"
            >
                <a
                    class="shop-link"
                    id="popular"
                    @click.prevent="setActive('popular')"
                    >လူကြိုက်များသောဆိုင်များ</a
                >
            </div>
            <div
                class="premium_nav shop-item"
                :class="{ shop_active: this.activeItem == 'premium' }"
            >
                <a
                    class="shop-link"
                    id="premium"
                    @click.prevent="setActive('premium')"
                    >Premium</a
                >
            </div>
        </slick>
        ...
        >
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div
                    class="d-flex align-items-center position-relative sn-shop-search"
                >
                    <input
                        type="text"
                        v-model="search"
            ...
            >
                ...
                >
                    <div
                        class="images post-img sop-img shop-img position-relative pt-1"
                    >
                        ...
                        <a :href="'/' + d.shop_name_url">
                            <img
                                ...
                                :src="imgurl+'/shop_owner/logo/mid/' + d.shop_logo"
                                class="sn-shop-image"
                            />
                        </a>
                    </div>
